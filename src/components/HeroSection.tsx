...
export default function HeroSection() {
  return (
    <section className="relative min-h-screen flex flex-col items-center justify-center px-4 pt-12 pb-20">
      {/* Top bar */}
      <div className="flex items-center gap-2 mb-8 text-wp-blue/100 text-xs tracking-[0.3em] uppercase">
        <span className="text-wp-blue/100">//</span>
        <span>WP Gang — Custom WordPress Plugins &amp; Tools</span>
        <span className="text-wp-blue/100">//</span>
      </div>
      ...
      <h1 className="text-center">
        <span className="block text-4xl md:text-6xl lg:text-7xl font-semibold text-white tracking-tight leading-[1.0]">
          HERODOTUS
        </span>
        <span className="block text-4xl md:text-6xl lg:text-7xl font-bold text-wp-blue tracking-tight leading-[1.1] mt-1">
          ON THIS DAY
        </span>
      </h1>
